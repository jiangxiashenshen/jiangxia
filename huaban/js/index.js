...
//    1获取标签
    ...
    var allDoms = $('tab_content').children;
    var last = 0;
    ...
    for (var i = 0; i < allLis.length; i++) {
        ...
        (function (i) {
            li.onmousedown = function () {
                //清除样式
                allLis[last].className = '';
                allDoms[last].style.display = 'none';
                //设置样式
                this.className = 'current';
                allDoms[i].style.display = 'block';
                last = i;
            }
        })(i);
    }
